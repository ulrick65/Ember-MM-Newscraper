...
#Region "Methods"
    ...
    ''' <summary>
    ''' Creates a deep copy of this clsXMLSimpleMapping instance.
    ''' </summary>
    ''' <returns>A new clsXMLSimpleMapping object with all properties copied.</returns>
    ''' <remarks>
    ...
    Public Function CloneDeep() As Object Implements ICloneable.Clone
        ...
        Return JsonConvert.DeserializeObject(Of clsXMLSimpleMapping)(json)
    End Function
