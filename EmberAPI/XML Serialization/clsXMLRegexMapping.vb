...
#Region "Methods"
    ...
    ''' <summary>
    ''' Creates a deep copy of this clsXMLRegexMapping instance.
    ''' </summary>
    ''' <returns>A new clsXMLRegexMapping object with all properties copied.</returns>
    ''' <remarks>
    ...
    Public Function CloneDeep() As Object Implements ICloneable.Clone
        ...
        Return JsonConvert.DeserializeObject(Of clsXMLRegexMapping)(json)
    End Function
