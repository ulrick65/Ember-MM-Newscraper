...
#Region "Methods"
    ...
    Private Sub PopulateMappings()
        Dim nMapping As clsXMLRegexMapping = Nothing
        Select Case _Type
            Case MappingType.EditionMapping
                nMapping = CType(APIXML.EditionMapping.CloneDeep, clsXMLRegexMapping)
        End Select
    ...
    Public Sub SaveChanges()
        ...
        Select Case _Type
            Case MappingType.EditionMapping
                APIXML.EditionMapping.Mappings = nRegexMapping
                APIXML.EditionMapping.Save()
        End Select
    End Sub
