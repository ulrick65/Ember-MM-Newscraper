...
#Region "Methods"
    ...
    Private Sub CheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkIMDb.CheckedChanged, chkMetascore.CheckedChanged, chkTomatometer.CheckedChanged, txtApiKey.TextChanged
