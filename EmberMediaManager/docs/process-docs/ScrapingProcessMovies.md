...
> **Related Documentation:** For TV Show scraping, see [../process-docs/ScrapingProcessTvShows.md](ScrapingProcessTvShows.md). Both processes share architectural patterns through the `ModulesManager` class.
